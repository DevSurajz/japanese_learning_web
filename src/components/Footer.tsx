      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: "flex", gap: 24, alignItems: "center", width: isMobile ? "100%" : 200, justifyContent: isMobile ? "center" : "flex-end" }}>
            <a href="https://github.com/DevSurajz" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 14, color: 'inherit', textDecoration: 'none' }}>
            ...
            <a href="https://x.com/Devyavz" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 14, color: 'inherit', textDecoration: 'none' }}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
